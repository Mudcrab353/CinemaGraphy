...
> **Anime Catalogs:** با همون آیدی داخلی `kitsu:` کار می‌کنه (حتی اگه از تنظیماتش MyAnimeList رو انتخاب کرده باشی — خود این افزونه همه‌چی رو به Kitsu نگاشت می‌کنه). از نسخه‌ی ۱.۲ پخش هم وصله: اسم انیمه از Kitsu گرفته میشه و تو پروایدرهای خودمون سرچ میشه.
