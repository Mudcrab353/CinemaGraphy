...
const PROVIDER_BASEURL_KEYS = [
    ...
    'SERIALBLOG_BASEURL', 'DIGIMOVIE_BASEURL', 'DONYAYESERIAL_BASEURL', 'ANIMEX_BASEURL',
]
const PROVIDER_KEY_TO_ENV = {
    f2media: 'F2MEDIA_BASEURL', peepboxtv: 'PEEPBOXTV_BASEURL', cinamatic: 'CINAMATIC_BASEURL',
    aslmoviez: 'ASLMOVIEZ_BASEURL', serialblog: 'SERIALBLOG_BASEURL', digimovie: 'DIGIMOVIE_BASEURL',
...
const CONFIG_ALLOW = new Set([
    ...
    'CATALOG_TMDB_MANIFEST_URL', 'PROVIDER_TIMEOUT_MS', 'DIGIMOVIE_USERNAME', 'DIGIMOVIE_PASSWORD',
    'PROXY_ENABLE', 'PROXY_URL', 'PROXY_PATH', 'DISABLE_META', 'DISABLE_CATALOG', 'DISABLE_SUBTITLES',
    'STREAMS_ONLY', 'ADDON_NAME_SUFFIX', 'META_LANG', 'ADDON_LANG', 'ENABLE_IPTV', 'ENABLE_NAMAKADE',
